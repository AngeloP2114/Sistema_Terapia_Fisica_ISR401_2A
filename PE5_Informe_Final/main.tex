...
\begin{figure}[H]\centering\includegraphics[width=0.82\textwidth]{figuras/casos_uso_10_pe5.png}\caption{Diagrama de casos de uso PE5 con diez casos.}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=\textwidth]{figuras/dfd_nivel1_pe5.png}\caption{DFD nivel 1 del SICST.}\end{figure}
...
M2&\texttt{auditoria\_consistencia\_pares\_FINAL.csv}.&Revisar los 10 pares seleccionados, marcar conflicto 0/1, documentar resolución y comprobar cero abiertos.&Ante cambios en permisos, consentimiento, alertas, IA, rutinas o reportes.\\
...
M5&\texttt{impacto\_modificabilidad\_FINAL.csv}.&Recorrer dependencias de los cinco RF de muestra, contar requisitos afectados y calcular promedio.&Cuando se modifiquen dependencias o se apruebe un RFC que afecte la muestra.\\
M6&\texttt{reinspeccion\_fagan\_FINAL.csv}.&Revisar D-01 a D-16 contra el ERS vigente y dividir defectos residuales para el total de requisitos.&Después de cambios mayores del ERS o antes de una nueva línea base.\\
\bottomrule\end{longtable}
...
\section*{Anexo C — Especificación ampliada de IA}\addcontentsline{toc}{section}{Anexo C — Especificación ampliada de IA}
...
\section*{Anexo D — Gestión y contribución del equipo}\addcontentsline{toc}{section}{Anexo D — Gestión y contribución del equipo}
...
\section*{Anexo E — Declaración de uso responsable de IA}\addcontentsline{toc}{section}{Anexo E — Declaración de uso responsable de IA}
